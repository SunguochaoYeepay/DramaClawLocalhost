...
HUIMENG_MUSIC_MODEL = os.environ.get("HUIMENG_MUSIC_MODEL", "suno-5.5")
...
DEFAULT_SKETCH_IMAGE_SELECTION = os.environ.get(
    "DEFAULT_SKETCH_IMAGE_SELECTION", "comfyui_flux2"
)
DEFAULT_RENDER_IMAGE_SELECTION = os.environ.get(
    "DEFAULT_RENDER_IMAGE_SELECTION", "comfyui_flux2"
)
